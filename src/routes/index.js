...
export default function Router() {
  return useRoutes([
    ...
    // Cashsafe Routes
    {
      ...
      children: [
        { path: '/', element: <Navigate to="/cashsafe/dashboard" replace /> },
        { path: 'dashboard', element: <CashsafeDashboard /> },
        { path: 'launchpad', element: <CashsafeLaunchPad /> },
        { path: 'launchpad/create', element: <CashsafeNewLaunchPad /> },
        { path: 'tokenlocker', element: <CashsafeTokenLocker /> },
        { path: 'lplocker', element: <CashsafeLiquidityLocker /> },
      ]
    },
    ...
    // Cashswap Routes
    {
      ...
      children: [
        { path: '/', element: <Navigate to="/cashswap/dashboard" replace /> },
        { path: 'dashboard', element: <GeneralApp /> },
        { path: 'swap', element: <GeneralApp /> },
        { path: 'liquidity', element: <GeneralApp /> },
        { path: 'farms', element: <GeneralApp /> },
        { path: 'pools', element: <GeneralApp /> },
      ]
    },
...
// Cashsafe
const CashsafeDashboard = Loadable(lazy(() => import('../pages/cashsafe/Dashboard')));
const CashsafeLaunchPad = Loadable(lazy(() => import('../pages/cashsafe/LaunchPad')));
const CashsafeNewLaunchPad = Loadable(lazy(() => import('../pages/cashsafe/NewLaunchPad')));
const CashsafeTokenLocker = Loadable(lazy(() => import('../pages/cashsafe/TokenLocker')));
const CashsafeLiquidityLocker = Loadable(lazy(() => import('../pages/cashsafe/LiquidityLocker')));
